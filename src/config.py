...
NDINITPOS = 4.0e5
EPSRATIO = 0.03#レーザーパワーの許容誤差比率．(1.0±epsratio)*目標パワーの範囲で許容する

EXCITEPOWERPIDNORMALIZATION = 4.0e7
...
EXCITEWAVELENGTHPIDKP = 0.03
EXCITEWAVELENGTHPIDKI = 0.001
EXCITEWAVELENGTHPIDKD = 0.001
